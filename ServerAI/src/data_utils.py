...
def draw_labels_and_boxes(image, labels, boxes):
    ...
    image = cv2.putText(image, "License-plate", (x_min, y_min - 3), cv2.FONT_HERSHEY_SIMPLEX, fontScale=0.4, color=(255, 251, 0), thickness=1)
    image = cv2.putText(image, labels, (x_min, y_min - 50), cv2.FONT_HERSHEY_SIMPLEX, fontScale=0.75, color=(0, 0, 255), thickness=2)
